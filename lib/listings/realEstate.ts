...
export async function requireRealEstateClient() {
  ...
  if (client.industry !== "Real Estate") return { error: "Forbidden", status: 403 };

  return { client: client as RealEstateClient };
}
